...
{
    private static readonly Dictionary<string, Color> StartupColorPreferences = new() { { "Избранное", Colors.Orange } };
    ...
    {
        if (ColorPreferences.TryGetValue(value, out var color))
        {
            return color;
        }
